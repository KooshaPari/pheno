 ...
 *   AppGen         e.g. "MyApp"
 *   com.phenotype.appgen           e.g. "com.example.myapp"
 *   0.1.0      e.g. "0.1.0"
 *   http://localhost:8081  e.g. "http://localhost:3000"
 *   ../web/dist/index.html e.g. "../web/dist/index.html"  (relative from this dir)
 */
import type { ElectrobunConfig } from "electrobun";

// ── CONFIGURE 1: App identity ─────────────────────────────────────────────────
const APP_NAME = "AppGen";
const APP_ID = "com.phenotype.appgen";
const APP_VERSION = "0.1.0";

// ── CONFIGURE 2: Renderer (dev server URL or bundled views path) ──────────────
const DEFAULT_DEV_URL = "http://localhost:8081";
